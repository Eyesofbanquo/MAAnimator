...
@interface UIView (SWIFT_EXTENSION(MAAnimators))
@end

@protocol UIViewControllerContextTransitioning;

@interface UIViewController (SWIFT_EXTENSION(MAAnimators)) <UIViewControllerAnimatedTransitioning, UIViewControllerTransitioningDelegate>
